...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "enableCrashReportDesc":
            MessageLookupByLibrary.simpleMessage("自动提交应用崩溃日志"),
        ...
        "clearCacheDesc":
            MessageLookupByLibrary.simpleMessage("是否需要清理FakeIP&DNS缓存？"),
        ...
        "fcmTip": MessageLookupByLibrary.simpleMessage(
            "FCM连接和支持取决于设备本身，结果仅供参考。因Android底层权限原因，在手机上您需要关闭网络中的\"允许绕过VPN\"选项以获得更加准确的结果"),
        ...
        "forceGCDesc":
            MessageLookupByLibrary.simpleMessage("是否进行强制内核垃圾回收？实验性功能，请谨慎使用"),
        "findProcessMode": MessageLookupByLibrary.simpleMessage("查找进程"),
        "findProcessModeDesc":
            MessageLookupByLibrary.simpleMessage("开启后会将可以查找进程"),
        ...
        "smartAutoStopDesc":
            MessageLookupByLibrary.simpleMessage("连接指定内网后停止代理服务"),
        "networkMatch": MessageLookupByLibrary.simpleMessage("网络匹配"),
        "networkMatchHint":
            MessageLookupByLibrary.simpleMessage("输入IP或CIDR，最多2个，逗号分隔"),
        "smartAutoStopServiceRunning":
            MessageLookupByLibrary.simpleMessage("智能启停服务运行中"),
        ...
        "dozeSuspendDesc":
            MessageLookupByLibrary.simpleMessage("开启后同步支持Doze休眠模式"),
        ...
        "icmpForwardingDesc":
            MessageLookupByLibrary.simpleMessage("开启后将支持ICMPing"),
